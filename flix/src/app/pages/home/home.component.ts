...
export class HomeComponent {
  ...
  popularMysteryMovieResults: any = []
  ...
  popularMysteryMovieData() {
    this.service.popularMysteryMovieApiData().subscribe((result) => {
      this.popularMysteryMovieResults = result.results;
    })
  }
